"""
Tests for PromptBuilder, including default and JSON formatting,
sanitization, and templates.
"""
...
def test_prompt_builder_json():
    ...
    Note:
    In the refactored architecture, PromptBuilder no longer trusts
    session["user_id"] directly. When no explicit engine/user context
    is provided, the JSON formatter defaults the session identifier
    to "unknown".
    """
    ...
    # Updated expectation: default session id is now "unknown"
